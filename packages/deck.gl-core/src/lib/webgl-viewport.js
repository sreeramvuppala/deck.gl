...
export const COORDINATE_SYSTEM = {
  ...
  MERCATOR_LNGLAT: 1.0,
  // Positions are interpreted as lnglat offsets from lnglat center, distances as meters
  MERCATOR_LNGLAT_OFFSETS: 3.0,
  // Positions are interpreted as meter offsets from lnglat center, distances as meters
  MERCATOR_METER_OFFSETS: 2.0,
...
// TODO - the name of this class is confusing - replace with a function?
// This is a wrapper for a `Viewport` from `viewport-mercator-project`
